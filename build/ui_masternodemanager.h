...
public:
    ...
    void retranslateUi(QWidget *MasternodeManager)
    {
        ...
        label_2->setText(QApplication::translate("MasternodeManager", "SONO Masternodes Activated:", 0));
        countLabel->setText(QApplication::translate("MasternodeManager", "0", 0));
        label->setText(QApplication::translate("MasternodeManager", "Sorting function is in ALPHA phase", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MasternodeManager", "SONO Masternodes Network", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("MasternodeManager", "My SONO Masternode", 0));
    } // retranslateUi
