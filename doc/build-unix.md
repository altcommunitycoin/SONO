...
memory available when compiling SONO Core. With 512MB of memory or less
...
If you want to build SONO-Qt, make sure that the required packages for Qt development
...
# Pick some path to install BDB to, here we create a directory within the SONO directory
...
2) The release is built with GCC and then "strip SONOd" to strip the debug
...
Security
--------
To help make your SONO installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, SONO should be built with a non-executable stack
