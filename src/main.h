...
#define START_MASTERNODE_PAYMENTS_TESTNET 1517076000
#define START_MASTERNODE_PAYMENTS 1517076000
...
static const int64_t DARKSEND_COLLATERAL = (1000*COIN); //1000 SONO
