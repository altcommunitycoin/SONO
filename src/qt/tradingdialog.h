...
private slots:
    ...
    QString BuySONO(QString OrderType, double Quantity, double Rate);
    QString SellSONO(QString OrderType, double Quantity, double Rate);
