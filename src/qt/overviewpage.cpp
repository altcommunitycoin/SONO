    ...
    filter(0)
{
    ...
    ui->frameluxsend->setVisible(false);  // Hide darksend features
 ...
 // start with displaying the "out of sync" warnings
    ...
    if(fMasterNode || fLiteMode){
        ...
        ui->toggleluxsend->setText(tr("Start darksend"));
    } else {
        ui->toggleluxsend->setText(tr("Stop darksend"));
    }
...
void OverviewPage::updateluxsendProgress()
{
    ...
    int64_t nMaxToAnonymize = nAnonymizeSONOAmount*COIN;
