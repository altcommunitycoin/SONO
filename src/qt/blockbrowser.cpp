...
{
    if(Height > pindexBest->nHeight) { return "00000f14896ba98013ed07e0ecf6e29b360a20898aab5c23238fd08c17ac1b10"; }
    if(Height < 0) { return "00000f14896ba98013ed07e0ecf6e29b360a20898aab5c23238fd08c17ac1b10"; }
    int desiredheight;
...
void BlockBrowser::updateStatistics()
{
    ...
    double nSubsidy = 1;
    if(pindexBest->nHeight < 240000 && pindexBest->nHeight > 500)
    {
        nSubsidy = 1;
    }
    else if(pindexBest->nHeight > 240001)
    {
        nSubsidy = 2;
    }
    ...
    {
        ui->volumeBox_2->setText("<b><font color=\"green\">" + qVolume + " SONO" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox_2->setText("<b><font color=\"red\">" + qVolume + " SONO" + "</font></b>");
    } else {
        ui->volumeBox_2->setText(qVolume + " SONO");
    }
