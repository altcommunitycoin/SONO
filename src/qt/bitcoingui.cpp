...
#endif
    setObjectName("SONO");
    setStyleSheet("#SONO {background-image: url(:/images/qt) }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
/*
    ...
    generateAction->setToolTip(tr("SONO mining and staking management"));
...
//  connect(generateAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
 ...
 // connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    aboutAction = new QAction(tr("&About SONO"), this);
