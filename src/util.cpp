...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\SONO
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\SONO
    // Mac: ~/Library/Application Support/SONO
    // Unix: ~/.SONO
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SONO";
#else
    fs::path pathRet;
